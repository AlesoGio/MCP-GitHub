...
load_dotenv()  # carica automaticamente le variabili da un file .env nella root del progetto
...
class ServerSettings(BaseSettings):
    ...
    github_callback_path: AnyHttpUrl
...
class SimpleGitHubOAuthProvider(OAuthAuthorizationServerProvider):
    ...
    def __init__(self, settings: ServerSettings):
        print("Sono entrato nella funzione __init__")
    ...
    async def get_client(self, client_id: str) -> OAuthClientInformationFull | None:
        print("Sono entrato nella funzione get_client")
        """Get OAuth client information."""
        return self.clients.get(client_id)

    async def register_client(self, client_info: OAuthClientInformationFull):
        print("Sono entrato nella funzione register_client")
        """Register a new OAuth client."""
        self.clients[client_info.client_id] = client_info

    async def authorize(self, client: OAuthClientInformationFull, params: AuthorizationParams) -> str:
        print("Sono entrato nella funzione authorize")
    ...
    async def handle_github_callback(self, code: str, state: str) -> str:
        print("Sono entrato nella funzione handle_github_callback")
    ...
    async def load_authorization_code(
        ...
        print("Sono entrato nella funzione load_authorization_code")
    ...
    async def exchange_authorization_code(
        ...
        print("Sono entrato nella funzione exchange_authorization_code")
    ...
    async def load_access_token(self, token: str) -> AccessToken | None:
        print("Sono entrato nella funzione load_access_token")
    ...
    async def load_refresh_token(self, client: OAuthClientInformationFull, refresh_token: str) -> RefreshToken | None:
        print("Sono entrato nella funzione load_refresh_token")
    ...
    async def exchange_refresh_token(
        ...
        print("Sono entrato nella funzione exchange_refresh_token")
        """Exchange refresh token"""
        raise NotImplementedError("Not supported")

    async def revoke_token(self, token: str, token_type_hint: str | None = None) -> None:
        print("Sono entrato nella funzione revoke_token")
        """Revoke a token."""
...
def create_simple_mcp_server(settings: ServerSettings) -> FastMCP:
    print("Sono entrato nella funzione create_simple_mcp_server")
    ...
    async def github_callback_handler(request: Request) -> Response:
        print("Sono entrato nella funzione github_callback_handler")
        """Handle GitHub OAuth callback."""
    ...
    def get_github_token() -> str:
        print("Sono entrato nella funzione get_github_token")
    ...
    async def get_user_profile() -> dict[str, Any]:
        print("Sono entrato nella funzione get_user_profile")
    ...
    async def list_repositories() -> list[dict[str, Any]]:
        print("Sono entrato nella funzione list_repositories")
        github_token = get_github_token()
    ...
    async def get_repository_info(repo_name: str) -> dict[str, Any]:
        print("Sono entrato nella funzione get_repository_info")
        github_token = get_github_token()

        # Ottieni lo username GitHub dell'utente autenticato
...
@click.command()
@click.option("--port", default=int(os.environ.get("PORT", 8000)), help="Port to listen on")
...
def main(port: int, host: str, transport: Literal["stdio", "sse", "streamable-http"]) -> int:
